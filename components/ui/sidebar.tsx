...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-8 shrink-0 items-center rounded-xl px-3 text-base font-medium text-sidebar-foreground/70 ring-sidebar-ring outline-hidden transition-[margin,opacity] duration-200 ease-linear group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0 focus-visible:outline-none [&>svg]:size-6 [&>svg]:shrink-0",
        className
      )}
      {...props}
    />
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button group/menu-button flex w-full items-start gap-2 overflow-hidden rounded-none px-3 py-2 text-left text-base ring-sidebar-ring outline-hidden transition-[width,height,padding] duration-200 group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:items-center! group-data-[collapsible=icon]:p-2! hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:outline-none active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 has-[>svg:first-child]:pl-2.5 has-[>svg:last-child]:pr-2.5 group-data-[collapsible=icon]:has-[>svg:first-child]:!pl-0 group-data-[collapsible=icon]:has-[>svg:last-child]:!pr-0 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-open:hover:bg-sidebar-accent data-open:hover:text-sidebar-accent-foreground border-l-[3px] border-l-transparent data-active:border-l-white data-active:bg-sidebar-accent data-active:font-medium data-active:text-sidebar-accent-foreground [&_svg]:mt-0.5 [&_svg]:size-6 [&_svg]:shrink-0 group-data-[collapsible=icon]:[&_svg]:mt-0 [&>span:last-child]:min-w-0 [&>span:last-child]:whitespace-normal [&>span:last-child]:break-words",
  {
    variants: {
      variant: {
      ...
      size: {
        default: "min-h-8 h-auto text-base",
        sm: "h-7 text-xs",
        lg: "min-h-12 h-auto px-3 text-base group-data-[collapsible=icon]:p-0!",
      },
    },
    defaultVariants: {
      variant: "default",
